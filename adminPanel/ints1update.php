...
<!--end slidebar-->
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2><strong>Sem1-<?php print("$mont"); ?></strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints1up.php">
  ...
  <th>
     ...
     include 'db_connect.php';
            switch($mon)
            {
              case 'umon1':
              {
                    $query1 = "SELECT * FROM `sem1internal1`";
              ...
              case 'umon2':
              {
                    $query1 = "SELECT * FROM `sem1internal2`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
              ...
              case 'umon3':
              {
                    $query1 = "SELECT * FROM `sem1internal3`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
