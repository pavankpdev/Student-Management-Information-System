  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2>Attendence sem 6 <?php print("$mont");?></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/atds6up.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">Network Security Mgmt:</label>
              <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="sci_lab">Sofware Testing Lab:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="usci_lab" id="usci_lab">
                </div>
                </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="be_lab">Network Security lab:</label>
                    <div class="col-sm-4">
