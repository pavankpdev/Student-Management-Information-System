  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
        <h2><strong>Modify Attendence Sem 1 <?php print("$mont");?></strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/atds1up.php">
              ...
              case 'umon1':
              {
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['maths_1']."</td>";
                        echo "<td>".$row['applied_science']."</td>";
                        echo "<td>".$row['Ceee']."</td>";
                        echo "<td>".$row['Science_lab']."</td>";
                        echo "<td>".$row['Be_lab']."</td>";
                        echo "<td>".$row['Bcs_lab']."</td>";
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
        table.rows[i].onclick = function()
        {
             ...
             document.getElementById("ube_lab").value = this.cells[5].innerHTML;
              ...
              document.getElementById("umonthint").value = this.cells[7].innerHTML;
        };
    }
