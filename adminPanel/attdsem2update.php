  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2>Attendence Sem 2  <?php print("$mont"); ?></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/atds2up.php">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                  <label class="control-label col-sm-2" for="bcs_lab">M.M lab:</label>
                  <div class="col-sm-4">
              ...
              case 'umon1':
              {
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['maths_2']."</td>";
                        echo "<td>".$row['english']."</td>";
                        echo "<td>".$row['dcf']."</td>";
                        echo "<td>".$row['de_lab']."</td>";
                        echo "<td>".$row['basic_web_lab']."</td>";
