  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
        <h2><strong>Sem2-Internals</strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/internalsem2val.php">
		  <div class="form-group">
              <label class="control-label col-sm-2" for="internals">Internals:</label>
              <div class="col-sm-4">
		  <div>
			<select name="internalselect2">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="m2">M2:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="eng">Communication skills in english:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="eng">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="dcf">DCF:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control"name="dcf">
                </div>
              </div>


              <div class="form-group">
                <label class="control-label col-sm-2" for="de">De lab:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="web">Web desgin lab:</label>
                  <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="mul">Multimedia lab:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="mul">
                    </div>
                    </div>
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints2update.php">
            <div class="form-group">
