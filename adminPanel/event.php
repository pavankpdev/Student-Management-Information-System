    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/eventval.php">
            <div class="form-group">
                <label class="control-label col-sm-2" for="Eventname">Event ID:</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                <label class="control-label col-sm-2" for="newsname">Description:</label>
                <div class="col-sm-4">
