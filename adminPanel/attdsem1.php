  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
        <h2><strong>Insert Attendence Sem 1</strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdval1.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="m1">M1:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">Applied science:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="sci">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="ceee">Ceee:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control"name="ceee">
                </div>
              </div>


              <div class="form-group">
                <label class="control-label col-sm-2" for="sci_lab">Applied sciece lab:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="sci_lab">
                </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-sm-2" for="bcs_lab">Bcs lab:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="bcs_lab">
                  </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="be_lab">Be lab:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="be_lab">
                    </div>
                    </div>
            <div class="form-group">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdsem1update.php">
            <div class="form-group">
              <label class="control-label col-sm-2" for="month"> Select:</label>
