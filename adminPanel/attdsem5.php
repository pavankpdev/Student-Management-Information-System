  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
    <h2>Attendence sem 5</h2>          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdval5.php">
        ...
        <select name="monthselect">
          ...
          <option value="month4">4<sup>th</sup> Month</option>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="ada">:ADA</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="ada_lab">ADA_lab:</label>
                    <div class="col-sm-4">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdsem5update.php">
            <div class="form-group">
              <label class="control-label col-sm-2" for="month"> Select:</label>
