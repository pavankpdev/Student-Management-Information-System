  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
    <h2>Attendence sem 3</h2>          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdval3.php">
      <div class="form-group">
        ...
        <select name="monthselect">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="dbms_lab">DBMS_lab:</label>
                    <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="net_lab">Network_Admin_lab:</label>
                        <div class="col-sm-4">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdsem3update.php">
            <div class="form-group">
              <label class="control-label col-sm-2" for="month"> Select:</label>
