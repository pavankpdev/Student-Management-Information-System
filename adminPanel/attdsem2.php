  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2>Attendence Sem 2</h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdval2.php">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/attdsem2update.php">
            <div class="form-group">
              <label class="control-label col-sm-2" for="month"> Select:</label>
