    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Update Message</li>
        </ol>
          <meta charset="utf-8">
        ...
        <div class="container">
          <h2>Update Message For Students.</h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/msgval.php">
            <div class="form-group">
            <div class="col-sm-offset-2 col-sm-4">
            <label for="sel1">Message From:</label>
            ...
            <div class="col-sm-offset-2 col-sm-4">
                ...
                <textarea class="form-control" rows="5" name="msg" style="width:500px;"></textarea>
            </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-4">
