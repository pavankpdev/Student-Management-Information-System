...
<!--end slidebar-->
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2><strong>Sem3-<?php print("$mont"); ?></strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints3up.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="m1">C Programming:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">Computer Organization:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="sci" id="sci">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="ceee">D.B.M.S:</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="sci_lab">Computer Networks:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="be_lab">C Programming lab:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="be_lab" id="be_lab">
                  </div>
                  </div>
                 <div class="form-group">
                                    <label class="control-label col-sm-2" for="bcs_lab">D.B.M.S lab:</label>
                                    <div class="col-sm-4">
                                      <input type="text" class="form-control" name="bcs_lab" id="bcs_lab">
                                    </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="control-label col-sm-2" for="bcs_lab">Network Administration lab:</label>
                                    <div class="col-sm-4">
  ...
  <th>
      <tr>
        ...
        <th>C Programming Lab</th>
        <th>D.B.M.S Lab</th>
        <th>Network Administration Lab</th>
        <th>Month</th>
      </tr>
    </th>
     <?php
     include 'db_connect.php';
            switch($mon)
            {
              case 'umon1':
              {
                    $query1 = "SELECT * FROM `sem3internal1`";
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['programming_with_c']."</td>";
                        echo "<td>".$row['Computer_organisation']."</td>";
                        echo "<td>".$row['Dbms']."</td>";
                        echo "<td>".$row['Computer_networks']."</td>";
                        echo "<td>".$row['C_lab']."</td>";
                        echo "<td>".$row['Dbms_lab']."</td>";
                        echo "<td>".$row['Networking_administration_lab']."</td>";
              ...
              case 'umon2':
              {
                    $query1 = "SELECT * FROM `sem3internal2`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
              ...
              case 'umon3':
              {
                    $query1 = "SELECT * FROM `sem3internal3`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
