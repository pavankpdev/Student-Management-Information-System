  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
        <h2><strong>Sem3-Internals</strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/internalsem3val.php"">
		  ...
		  <div class="form-group" >
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="c">Programming With C:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="co">:Computer organisation</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="co">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="dbms">DBMS:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control"name="dbms">
                </div>
              </div>


              <div class="form-group">
                <label class="control-label col-sm-2" for="cn">Computer Network:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="c_lab">Programming with c lab:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="c_lab">
                  </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-sm-2" for="dbms_lab">DBMS lab:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="dbms_lab">
                    </div>
                    </div>

                    <div class="form-group">
                        <label class="control-label col-sm-2" for="net_lab">Network Admin lab:</label>
                        <div class="col-sm-4">
                          <input type="text" class="form-control" name="net_lab">
                        </div>
                        </div>
            <div class="form-group">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints3update.php">
            <div class="form-group">
