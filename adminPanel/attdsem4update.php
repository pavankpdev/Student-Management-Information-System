  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
    <h2>Attendence Sem 4 <?php print("$mont");?></h2>  
            <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/atds4up.php">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="be_lab">Data Structures lab:</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" name="ube_lab" id="ube_lab">
                    </div>
                    </div>
                    <div class="form-group">
                  <label class="control-label col-sm-2" for="bcs_lab">OOP with JAVA lab:</label>
                  <div class="col-sm-4">
