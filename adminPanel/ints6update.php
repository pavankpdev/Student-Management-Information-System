...
<!--end slidebar-->
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2><strong>Sem6-<?php print("$mont"); ?></strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints6up.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="m1">Software Testing:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">Network Security Management:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="sci" id="sci">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="ceee">Cloud Computing:</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="sci_lab">Network Security Lab:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="be_lab">Software Testing lab:</label>
                  <div class="col-sm-4">
  ...
  <th>
      <tr>
        ...
        <th>Network Security Management</th>
        <th>Cloud Computing</th>
        <th>Network Security Lab</th>
        <th>Software Testing Lab</th>
        <th>Month</th>
      </tr>
    </th>
     <?php
     include 'db_connect.php';
            switch($mon)
            {
              case 'umon1':
              {
                    $query1 = "SELECT * FROM `sem6internal1`";
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['NSM']."</td>";
                        echo "<td>".$row['CC']."</td>";
                        echo "<td>".$row['NSM_lab']."</td>";
                        echo "<td>".$row['ST_lab']."</td>";
              ...
              case 'umon2':
              {
                    $query1 = "SELECT * FROM `sem6internal2`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
              ...
              case 'umon3':
              {
                    $query1 = "SELECT * FROM `sem6internal3`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
