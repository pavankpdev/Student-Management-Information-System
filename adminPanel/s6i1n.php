  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
        <h2><strong>Sem6-Internals</strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/internalsem6val.php">
		  <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="st">Sofware Testing:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="">Network Security Management:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="ns">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="cc">Cloud computing:</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="st_lab">Software testing lab:</label>
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="st_lab">
                </div>
                </div>

                <div class="form-group">
                  <label class="control-label col-sm-2" for="ns_lab">Network Security lab:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="ns_lab">
                  </div>
                  </div>
            <div class="form-group">
          ...
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints6update.php">
            <div class="form-group">
