  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
    <h2>Attendence sem 3 <?php print("$mont");?></h2>         
    <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/atds3up.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">Computer Organisation:</label>
              <div class="col-sm-4">
              ...
              case 'umon1':
              {
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['prog_with_c']."</td>";
                        echo "<td>".$row['co']."</td>";
                        echo "<td>".$row['dbms']."</td>";
                        echo "<td>".$row['cn']."</td>";
                        echo "<td>".$row['c_lab']."</td>";
                        echo "<td>".$row['dbms_lab']."</td>";
                        echo "<td>".$row['network_admin_lab']."</td>";
