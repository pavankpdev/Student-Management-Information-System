...
<!--end slidebar-->
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="container">
          <h2><strong>Sem2-<?php print("$mont"); ?></strong></h2>
          <form class="form-horizontal" method="POST" action="http://localhost/newtest/adminPanel/ints2up.php">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="m1">M2:</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              <label class="control-label col-sm-2" for="sci">English:</label>
              <div class="col-sm-4">
                <input type="text" class="form-control" name="sci" id="sci">
              </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-2" for="ceee">D.C.F:</label>
                <div class="col-sm-4">
              ...
              <div class="form-group">
                <label class="control-label col-sm-2" for="sci_lab">D.E lab:</label>
                <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-2" for="be_lab">Basic Web lab:</label>
                  <div class="col-sm-4">
                    <input type="text" class="form-control" name="be_lab" id="be_lab">
                  </div>
                  </div>
                                  <div class="form-group">
                                    <label class="control-label col-sm-2" for="bcs_lab">Multi Media lab:</label>
                                    <div class="col-sm-4">
  ...
  <th>
     ...
     include 'db_connect.php';
            switch($mon)
            {
              case 'umon1':
              {
                    $query1 = "SELECT * FROM `sem2internal1`";
                    ...
                    if($result1check>0)
                    {
                      while($row= mysqli_fetch_assoc($result1))
                      {
                        ...
                        echo "<td>".$row['Engg_maths2']."</td>";
                        echo "<td>".$row['English']."</td>";
                        echo "<td>".$row['Dcf']."</td>";
                        echo "<td>".$row['De_lab']."</td>";
                        echo "<td>".$row['Basic_web_design_lab']."</td>";
                        echo "<td>".$row['Multimedia_lab']."</td>";
              ...
              case 'umon2':
              {
                    $query1 = "SELECT * FROM `sem2internal2`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
              ...
              case 'umon3':
              {
                    $query1 = "SELECT * FROM `sem2internal3`";
                    $result1 = mysqli_query($con, $query1);
                    $result1check = mysqli_num_rows($result1);
                    if($result1check>0)
                    {
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
        table.rows[i].onclick = function()
        {
             ...
             document.getElementById("be_lab").value = this.cells[5].innerHTML;
              ...
              document.getElementById("monthint").value = this.cells[7].innerHTML;
        };
    }
