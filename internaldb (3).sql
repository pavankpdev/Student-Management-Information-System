...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 04, 2019 at 04:04 AM
...
DROP TABLE IF EXISTS `attendence_sem1`;
CREATE TABLE IF NOT EXISTS `attendence_sem1` (
...
DROP TABLE IF EXISTS `attendence_sub1`;
CREATE TABLE IF NOT EXISTS `attendence_sub1` (
...
DROP TABLE IF EXISTS `sem1attd`;
CREATE TABLE IF NOT EXISTS `sem1attd` (
  `regno` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem1attdm1`;
CREATE TABLE IF NOT EXISTS `sem1attdm1` (
...
DROP TABLE IF EXISTS `sem1attdm2`;
CREATE TABLE IF NOT EXISTS `sem1attdm2` (
  `reg_no` varchar(15) NOT NULL,
  `maths_1` int(11) NOT NULL,
  `applied_science` int(11) NOT NULL,
  `Ceee` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem1attdm3`;
CREATE TABLE IF NOT EXISTS `sem1attdm3` (
  `reg_no` varchar(15) NOT NULL,
  `maths_1` int(11) NOT NULL,
  `applied_science` int(11) NOT NULL,
  `Ceee` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem1attdm4`;
CREATE TABLE IF NOT EXISTS `sem1attdm4` (
  `reg_no` varchar(15) NOT NULL,
  `maths_1` int(11) NOT NULL,
  `applied_science` int(11) NOT NULL,
  `Ceee` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem1ia`;
CREATE TABLE IF NOT EXISTS `sem1ia` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem1internal1`;
CREATE TABLE IF NOT EXISTS `sem1internal1` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Engg_maths1` int(11) NOT NULL,
  `Science` int(11) NOT NULL,
...
('102cs16002', '2016', 12, 14, 12, 8, 6, 8),
...
DROP TABLE IF EXISTS `sem1internal2`;
CREATE TABLE IF NOT EXISTS `sem1internal2` (
  `Reg_no` varchar(15) NOT NULL,
...
('102cs16001', '2017', 12, 14, 12, 8, 6, 8),
('102cs16002', '2017', 12, 14, 14, 8, 6, 8),
...
DROP TABLE IF EXISTS `sem1internal3`;
CREATE TABLE IF NOT EXISTS `sem1internal3` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(11) NOT NULL,
  `Engg_maths1` int(11) NOT NULL,
  `Science` int(11) NOT NULL,
...
('102cs16001', '2016', 12, 14, 12, 8, 6, 8),
('102cs16002', '2016', 12, 14, 12, 8, 8, 8),
...
DROP TABLE IF EXISTS `sem2attdm1`;
CREATE TABLE IF NOT EXISTS `sem2attdm1` (
  `reg_no` varchar(15) NOT NULL,
...
DROP TABLE IF EXISTS `sem2attdm2`;
CREATE TABLE IF NOT EXISTS `sem2attdm2` (
  `reg_no` varchar(15) NOT NULL,
  `maths_2` int(11) NOT NULL,
  `english` int(11) NOT NULL,
  `dcf` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem2attdm3`;
CREATE TABLE IF NOT EXISTS `sem2attdm3` (
  `reg_no` varchar(15) NOT NULL,
  `maths_2` int(11) NOT NULL,
  `english` int(11) NOT NULL,
  `dcf` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem2attdm4`;
CREATE TABLE IF NOT EXISTS `sem2attdm4` (
  `reg_no` varchar(15) NOT NULL,
  `maths_2` int(11) NOT NULL,
  `english` int(11) NOT NULL,
  `dcf` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem2ia`;
CREATE TABLE IF NOT EXISTS `sem2ia` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem2internal1`;
CREATE TABLE IF NOT EXISTS `sem2internal1` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Engg_maths2` int(11) NOT NULL,
  `English` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem2internal2`;
CREATE TABLE IF NOT EXISTS `sem2internal2` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Engg_maths2` int(11) NOT NULL,
  `English` int(11) NOT NULL,
...
('102cs16001', '2017', 15, 13, 10, 8, 6, 7),
('102cs16002', '2017', 12, 14, 12, 8, 6, 8),
...
DROP TABLE IF EXISTS `sem2internal3`;
CREATE TABLE IF NOT EXISTS `sem2internal3` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Engg_maths2` int(11) NOT NULL,
  `English` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem3attdm1`;
CREATE TABLE IF NOT EXISTS `sem3attdm1` (
  `reg_no` varchar(15) NOT NULL,
...
DROP TABLE IF EXISTS `sem3attdm2`;
CREATE TABLE IF NOT EXISTS `sem3attdm2` (
  `reg_no` varchar(15) NOT NULL,
  `prog_with_c` int(11) NOT NULL,
  `co` int(11) NOT NULL,
  `dbms` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem3attdm3`;
CREATE TABLE IF NOT EXISTS `sem3attdm3` (
  `reg_no` varchar(15) NOT NULL,
  `prog_with_c` int(11) NOT NULL,
  `co` int(11) NOT NULL,
  `dbms` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem3attdm4`;
CREATE TABLE IF NOT EXISTS `sem3attdm4` (
  `reg_no` varchar(15) NOT NULL,
  `prog_with_c` int(11) NOT NULL,
  `co` int(11) NOT NULL,
  `dbms` int(11) NOT NULL,
...
('102cs16010', 12, 10, 12, 15, 7, 6, 5, '1stmonth'),
('102cs16018', 12, 13, 11, 14, 15, 8, 9, 'march'),
('102cs19039', 22, 12, 12, 12, 8, 8, 10, 'jan');
...
DROP TABLE IF EXISTS `sem3ia`;
CREATE TABLE IF NOT EXISTS `sem3ia` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem3internal1`;
CREATE TABLE IF NOT EXISTS `sem3internal1` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `programming_with_c` int(11) NOT NULL,
  `Computer_organisation` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem3internal2`;
CREATE TABLE IF NOT EXISTS `sem3internal2` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `programming_with_c` int(11) NOT NULL,
  `Computer_organisation` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem3internal3`;
CREATE TABLE IF NOT EXISTS `sem3internal3` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `programming_with_c` int(11) NOT NULL,
  `Computer_organisation` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4attdm1`;
CREATE TABLE IF NOT EXISTS `sem4attdm1` (
  `reg_no` varchar(15) NOT NULL,
  `Ds` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4attdm2`;
CREATE TABLE IF NOT EXISTS `sem4attdm2` (
  `reg_no` varchar(15) NOT NULL,
  `Ds` int(11) NOT NULL,
  `oop_with_java` int(11) NOT NULL,
  `os` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4attdm3`;
CREATE TABLE IF NOT EXISTS `sem4attdm3` (
  `reg_no` varchar(15) NOT NULL,
  `Ds` int(11) NOT NULL,
  `oop_with_java` int(11) NOT NULL,
  `os` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4attdm4`;
CREATE TABLE IF NOT EXISTS `sem4attdm4` (
  `reg_no` varchar(15) NOT NULL,
  `Ds` int(11) NOT NULL,
  `oop_with_java` int(11) NOT NULL,
  `os` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4ia`;
CREATE TABLE IF NOT EXISTS `sem4ia` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem4internal1`;
CREATE TABLE IF NOT EXISTS `sem4internal1` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Datastructure_using_c` int(11) NOT NULL,
  `Oop_with_java` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4internal2`;
CREATE TABLE IF NOT EXISTS `sem4internal2` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Datastructure_using_c` int(11) NOT NULL,
  `Oop_with_java` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem4internal3`;
CREATE TABLE IF NOT EXISTS `sem4internal3` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Datastructure_using_c` int(11) NOT NULL,
  `Oop_with_java` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5attdm1`;
CREATE TABLE IF NOT EXISTS `sem5attdm1` (
  `reg_no` varchar(15) NOT NULL,
...
DROP TABLE IF EXISTS `sem5attdm2`;
CREATE TABLE IF NOT EXISTS `sem5attdm2` (
  `reg_no` varchar(15) NOT NULL,
  `web_prog` int(11) NOT NULL,
  `software_engg` int(11) NOT NULL,
  `daa` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5attdm3`;
CREATE TABLE IF NOT EXISTS `sem5attdm3` (
  `reg_no` varchar(15) NOT NULL,
  `web_prog` int(11) NOT NULL,
  `software_engg` int(11) NOT NULL,
  `daa` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5attdm4`;
CREATE TABLE IF NOT EXISTS `sem5attdm4` (
  `reg_no` varchar(15) NOT NULL,
  `web_prog` int(11) NOT NULL,
  `software_engg` int(11) NOT NULL,
  `daa` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5ia`;
CREATE TABLE IF NOT EXISTS `sem5ia` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Software_engg` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5internal1`;
CREATE TABLE IF NOT EXISTS `sem5internal1` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Software_engg` int(11) NOT NULL,
  `Web_programming` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5internal2`;
CREATE TABLE IF NOT EXISTS `sem5internal2` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Software_engg` int(11) NOT NULL,
  `Web_programming` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem5internal3`;
CREATE TABLE IF NOT EXISTS `sem5internal3` (
  `Reg_no` varchar(15) NOT NULL,
  `month` varchar(20) NOT NULL,
  `Software_engg` int(11) NOT NULL,
  `Web_programming` int(11) NOT NULL,
...
DROP TABLE IF EXISTS `sem6attdm1`;
CREATE TABLE IF NOT EXISTS `sem6attdm1` (
  `regno` varchar(20) NOT NULL,
  `st` int(3) NOT NULL,
  `nsm` int(3) NOT NULL,
  `cc` int(3) NOT NULL,
...
DROP TABLE IF EXISTS `sem6attdm2`;
CREATE TABLE IF NOT EXISTS `sem6attdm2` (
  `regno` varchar(20) NOT NULL,
  `st` int(3) NOT NULL,
  `nsm` int(3) NOT NULL,
  `cc` int(3) NOT NULL,
...
DROP TABLE IF EXISTS `sem6attdm3`;
CREATE TABLE IF NOT EXISTS `sem6attdm3` (
  `regno` varchar(20) NOT NULL,
  `st` int(3) NOT NULL,
  `nsm` int(3) NOT NULL,
  `cc` int(3) NOT NULL,
...
('102cs16018', 12, 11, 8, 9, 10, 'jan'),
('102cs19039', 11, 12, 12, 10, 8, 'march');
...
DROP TABLE IF EXISTS `sem6attdm4`;
CREATE TABLE IF NOT EXISTS `sem6attdm4` (
  `regno` varchar(20) NOT NULL,
  `st` int(3) NOT NULL,
  `nsm` int(3) NOT NULL,
  `cc` int(3) NOT NULL,
...
DROP TABLE IF EXISTS `sem6ia`;
CREATE TABLE IF NOT EXISTS `sem6ia` (
  `regno` varchar(20) NOT NULL,
...
DROP TABLE IF EXISTS `sem6internal1`;
CREATE TABLE IF NOT EXISTS `sem6internal1` (
  `regno` varchar(20) NOT NULL,
  `month` varchar(50) NOT NULL,
  `CC` int(3) NOT NULL,
  `NSM` int(3) NOT NULL,
...
DROP TABLE IF EXISTS `sem6internal2`;
CREATE TABLE IF NOT EXISTS `sem6internal2` (
  `regno` varchar(20) NOT NULL,
  `month` varchar(50) NOT NULL,
  `CC` int(3) NOT NULL,
  `NSM` int(3) NOT NULL,
...
DROP TABLE IF EXISTS `sem6internal3`;
CREATE TABLE IF NOT EXISTS `sem6internal3` (
  `regno` varchar(20) NOT NULL,
  `month` varchar(50) NOT NULL,
  `CC` int(3) NOT NULL,
  `NSM` int(3) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `semresult` (
  `sem` int(5) NOT NULL,
  `year` int(5) NOT NULL,
...
DROP TABLE IF EXISTS `student_pro_1`;
CREATE TABLE IF NOT EXISTS `student_pro_1` (
  ...
  `year` int(4) NOT NULL,
  `ph_no` int(10) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ph_no` (`ph_no`)
) ENGINE=InnoDB AUTO_INCREMENT=1886855798 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `student_pro_1`
--

INSERT INTO `student_pro_1` (`id`, `name`, `email`, `Mother_Name`, `Mother_Number`, `Father_Number`, `Father_Name`, `year_of_join`, `department`, `date_of_birth`, `year`, `ph_no`) VALUES
('', '', '', '', 0, 0, '', 0, '', '0000-00-00', 0, 1886855797),
('102160160', 'demo', 'demo@gmail.com', 'demo', 123456, 123456, 'demo', 2015, 'cs', '2019-01-23', 2015, 123),
('102CS16003', 'AKSHAY KUMAR.U', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-02-20', 2018, 978556344),
('102CS16004', 'ARBAZ', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1999-02-20', 2018, 976556348),
('102CS16005', 'CHANDRU', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-03-20', 2018, 978556314),
('102CS16006', 'DHARSHAN', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1999-02-21', 2018, 979556344),
('102CS16007', 'JBL', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-22', 2018, 970156344),
('102CS16008', 'NAVEEN', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-23', 2018, 971556344),
('102CS16009', 'SHARMA', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-24', 2018, 972556344),
('102CS16010', 'ROHIT', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-25', 2018, 879269877),
('102CS16011', 'KRISHNA', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-26', 2018, 974556344),
('102CS16012', 'ARYAN', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2001-02-20', 2018, 876556344),
('102CS16013', 'BALAJI', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-04-30', 2018, 776556344),
('102CS16014', 'ANIL', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-08-10', 2018, 971556144),
('102CS16015', 'AKASH', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2001-10-30', 2018, 976556444),
('102CS16016', 'APSAR', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '1998-02-20', 2018, 976556344),
('102cs16018', 'GOWTHAM', 'gowtham@gmail.com', 'mother', 144243, 4343434, 'father', 2016, 'computer science', '2000-12-30', 2018, 973963244),
('102cs16023', 'JOHN', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-08-03', 2018, 973556844),
('102cs16031', 'BHASKAR', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-01-03', 2018, 872556844),
('102cs16039', 'pavan kumar', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-07-15', 2018, 973963144),
('102cs160444', 'Demo', 'Demo@ddemo.demo', 'Demo mom', 897541231, 123546781, 'Demo dad', 2016, 'COMPUTER SCIENCE', '2000-01-30', 2018, 1686855796),
('102cs16048', 'ULLAS', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-06-03', 2018, 873556844),
('102cs16051', 'SHYAM', '', '', 0, 0, '', 2016, 'COMPUTER SCIENCE', '2000-08-30', 2018, 973556344),
('102cs160544', 'Demo', 'Demo@ddemo.demo', 'Demo mom', 897541231, 123546781, 'Demo dad', 2016, 'COMPUTER SCIENCE', '2000-01-30', 2018, 1786855796),
('102cs160644', 'Demo', 'Demo@ddemo.demo', 'Demo mom', 897541231, 123546781, 'Demo dad', 2016, 'COMPUTER SCIENCE', '2000-01-30', 2018, 1886855796),
('102cs17001', 'SUBHASH', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845399786),
('102cs17002', 'SUBHASH2', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 875399786),
('102cs17003', 'SUBHASH3', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 847399786),
('102cs17004', 'SUBHASH4', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845799786),
('102cs17005', 'SUBHASH5', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845379786),
('102cs17006', 'SUBHASH6', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845397786),
('102cs17007', 'SUBHASH7', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845399776),
('102cs17008', 'SUBHASH8', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 845399787),
('102cs17009', 'SUBHASH9', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 645399786),
('102cs17010', 'SUBHASH10', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-12-30', 2018, 865399786),
('102cs17011', 'SUBHASH11', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-11-30', 2018, 845399781),
('102cs17012', 'SUBHASH12', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-11-30', 2018, 845399782),
('102cs17013', 'SUBHASH13', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-11-30', 2018, 845399783),
('102cs17014', 'SUBHASH14', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-11-30', 2018, 445399784),
('102cs17015', 'SUBHASH15', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-10-30', 2018, 845399785),
('102cs17016', 'SUBHASH16', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-06-30', 2018, 645399787),
('102cs17017', 'SUBHASH17', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-11-30', 2018, 845399788),
('102cs17018', 'SUBHASH18', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-10-30', 2018, 845399789),
('102cs17019', 'SUBHASH19', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-08-30', 2018, 845399780),
('102cs17020', 'SUBHASH20', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-08-30', 2018, 845399716),
('102cs17021', 'SUBHASH21', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-08-30', 2018, 845399726),
('102cs17022', 'SUBHASH22', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-07-30', 2018, 845399736),
('102cs17023', 'SUBHASH23', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-06-30', 2018, 845399746),
('102cs17024', 'SUBHASH24', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-05-30', 2018, 845399756),
('102cs17025', 'SUBHASH25', '', '', 0, 0, '', 2015, 'COMPUTER SCIENCE', '1998-04-30', 2018, 845399766),
('102cs17033', 'pavan', 'jdjd@f.f', 'mother', 789654, 789654, 'father', 2017, 'cs', '2019-03-22', 3, 879654),
('102cskk15', 'kp', 'kp@kd.16', 'mom', 123654, 852369, 'dad', 2002, 'kp', '0200-12-25', 2023, 12364735),
('102cskkf1', 'kp', 'kp@kd.1f', 'mom', 123654, 852369, 'dad', 2002, 'kp', '0200-12-25', 2023, 7236473),
('102cskp12', 'kp', 'kp@fd.k', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 12364789),
('102cskp13', 'kp', 'kp@fd.o', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 12364788),
('102cskp14', 'kp', 'kp@fd.44', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 12364786),
('102cskp20', 'kp', 'kp@fd.54', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 12364766),
('102cskp22', 'kp', 'kp@fd.44', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 12364066),
('102cskpdd', 'kp', 'kp@fd.dd', 'mom', 123654, 852369, 'dad', 2000, 'kp', '0200-12-23', 2023, 72364066),
('102cskpdd1', 'kp', 'kp@fd.1f', 'mom', 123654, 852369, 'dad', 2001, 'kp', '0200-12-24', 2023, 72364726);
...
DROP TABLE IF EXISTS `st_ma_2018_jun_1`;
CREATE TABLE IF NOT EXISTS `st_ma_2018_jun_1` (
  `reg_no` varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS `st_ma_2018_jun_3`;
CREATE TABLE IF NOT EXISTS `st_ma_2018_jun_3` (
  `reg_no` varchar(10) NOT NULL,
  `exam_month_year` varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS `st_ma_2018_jun_5`;
CREATE TABLE IF NOT EXISTS `st_ma_2018_jun_5` (
  `reg_no` varchar(10) NOT NULL,
  `exam_month_year` varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS `st_ma_2019_jan_2`;
CREATE TABLE IF NOT EXISTS `st_ma_2019_jan_2` (
  `reg_no` varchar(10) NOT NULL,
  `exam_month_year` varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS `st_ma_2019_jan_4`;
CREATE TABLE IF NOT EXISTS `st_ma_2019_jan_4` (
  `reg_no` varchar(10) NOT NULL,
  `exam_month_year` varchar(30) NOT NULL,
...
DROP TABLE IF EXISTS `st_ma_2019_jan_6`;
CREATE TABLE IF NOT EXISTS `st_ma_2019_jan_6` (
  `reg_no` varchar(10) NOT NULL,
  `exam_month_year` varchar(30) NOT NULL,
...
('2', 'english', '15cp01e', 12, 13, 14, 15),
('2', 'math2', '15cs02m', 12, 4, 11, 11),
('1', 'BCS lab', '15CS11P', 9, 0, 0, 0),
('2', 'DCF', '15cs21t', 0, 1, 0, 0),
('2', 'basic web lab', '15cs22p', 0, 0, 0, 0),
('2', 'MM lab', '15cs23p', 0, 0, 0, 0),
('3', 'C Programming', '15cs31t', 0, 0, 0, 0),
('3', 'CO', '15cs32t', 0, 0, 0, 0),
('3', 'DBMS', '15cs33t', 0, 0, 0, 0),
('3', 'CN', '15cs34t', 0, 0, 0, 0),
('3', 'C Programming Lab', '15cs35p', 0, 0, 0, 0),
('3', 'DBMS & GUI lab', '15cs36p', 0, 0, 0, 0),
('3', 'Network Lab', '15cs37p', 0, 0, 0, 0),
('1', 'CEEE', '15EC01T', 9, 0, 0, 0),
('1', 'Basic Elec Lab', '15EC02P', 9, 0, 0, 0),
('2', 'DE lab', '15ec03p', 0, 0, 0, 0),
('1', 'Engg Math-1', '15SC01M', 1, 0, 0, 0),
('1', 'App Science', '15SC03S', 9, 1, 1, 0),
('1', 'App Sc Lab', '15SC04P', 9, 0, 0, 0),
